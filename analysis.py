...
def analyze_world_data(world_data, world_pop_data):
    ...
    world_data = world_data[world_data['iso_code'].isin(world_pop_data['Location'])].copy()
    ...
    average_per_cap_by_country = filled_world_data.groupby(['iso_code', 'location'])[WORLD_STATS].mean()
